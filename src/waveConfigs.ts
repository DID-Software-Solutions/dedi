...
export const WAVE_CONFIGS: WaveConfig[] = [
  ...
  { wave: 10, enemies: [{ type: EnemyType.Grunt, count: 14 }, { type: EnemyType.Rusher, count: 10 }, { type: EnemyType.Spitter, count: 5 }], spawnDelay: 700, intermission: 10000 },
  ...
  { wave: 15, enemies: [{ type: EnemyType.Grunt, count: 15 }, { type: EnemyType.Rusher, count: 15 }, { type: EnemyType.Spitter, count: 8 }, { type: EnemyType.Heavy, count: 5 }], spawnDelay: 500, intermission: 0 },
];
